  ...
  return (
    ...
    >
      ...
      <Nav className="flex-column gap-2">
        <Nav.Link
          onClick={() => handleLinkClick("/customer_home")}
          className={`d-flex align-items-center gap-3 px-4 py-3 sidebar-link ${pathname === "/customer_home"
            ? "bg-warning text-white fw-semibold"
            : "text-dark"
            }`}
        >
          <HomeIcon color={pathname === "/customer_home" ? "#fff" : "#292D32"} />
          Home
        </Nav.Link>
